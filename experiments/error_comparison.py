...
np.save(
    f"learnconv_results/freq_loc_error_squared_sampmean_{freq_loc_params}.npy",
    error_squared_sampmean_freq_loc,
)
np.save(
    f"learnconv_results/freq_loc_error_squared_sampstd_{freq_loc_params}.npy",
    error_squared_sampstd_freq_loc,
)

# Save time-localized results with time-loc specific parameters
np.save(
    f"learnconv_results/time_loc_error_squared_sampmean_{time_loc_params}.npy",
    error_squared_sampmean_time_loc,
)
np.save(
    f"learnconv_results/time_loc_error_squared_sampstd_{time_loc_params}.npy",
    error_squared_sampstd_time_loc,
)
