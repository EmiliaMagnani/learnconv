...
#     """
#     Runs inference (in Fourier domain) for input signals X and returns the Fourier coefficients of the prediction, and the prediction in the time domain,
#     and  optionally perform a grid search over lambda by setting optimize_lambda=True and providing lambda_candidates. 
...
#         A list or array of candidate lambda values (required if optimize_lambda is True).
...
#             raise ValueError(
#                 "When optimize_lambda is True, lambda_candidates must be provided."
#             )
#         best_error = np.inf
#         best_lambda = None
#         best_prediction_fourier = None
...
#         # Optionally, you might want to log the best lambda:
#         print(f"Best lambda found: {best_lambda} with error {best_error}")
#         return best_prediction_fourier, best_prediction_time_domain
#     else:
#         if lamb is None:
#             raise ValueError(
#                 "Parameter 'lamb' must be provided when optimize_lambda is False."
#             )
...
#                 best_prediction_fourier = pred_fourier
#                 best_prediction_time_domain = pred_time
#         # Optionally, you can log the best lambda here.
#         return best_prediction_fourier, best_prediction_time_domain
...
def compute_error(
    ...
    const : float
        Constant used to compute the regularization parameter λ.
